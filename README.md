...
[![Version](https://img.shields.io/badge/version-v1.3.2-blue)](https://github.com/Cod-e-Codes/marchat/releases/tag/v1.3.2)
...
**Latest tagged release:** [v1.3.2](https://github.com/Cod-e-Codes/marchat/releases/tag/v1.3.2) (2026-07-15). Narrative history: [CHANGELOG.md](CHANGELOG.md). Assets and tags: [GitHub releases](https://github.com/Cod-e-Codes/marchat/releases).
...
```bash
# Linux (amd64)
wget https://github.com/Cod-e-Codes/marchat/releases/download/v1.3.2/marchat-v1.3.2-linux-amd64.zip
unzip marchat-v1.3.2-linux-amd64.zip && chmod +x marchat-*

# macOS (amd64)
wget https://github.com/Cod-e-Codes/marchat/releases/download/v1.3.2/marchat-v1.3.2-darwin-amd64.zip
unzip marchat-v1.3.2-darwin-amd64.zip && chmod +x marchat-*
...
- Go 1.25.12 or later ([download](https://go.dev/dl/))
