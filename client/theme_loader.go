...
func ApplyCustomTheme(def ThemeDefinition) themeStyles {
	...
	s := themeStyles{
		...
		Box:        lipgloss.NewStyle().Border(lipgloss.NormalBorder()).BorderForeground(lipgloss.Color(def.Colors.BoxBorder)).Background(lipgloss.Color(transcriptFill)),
		...
		Background: lipgloss.NewStyle().Background(lipgloss.Color(altScreenFill)),
		screenBG:   altScreenFill,
