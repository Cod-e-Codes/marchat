...
| TUI client | Inject `tea.Msg`; no real terminal required |
...
- After material shifts, update figures in `README.md` and `TESTING.md`.
...
- Fudging assertions or deleting tests to green CI
