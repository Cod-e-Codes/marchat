...
- **Tooling**: Project Agent skills under `.cursor/skills/`; always-on rules in `.cursor/rules/marchat.mdc`. `.gitignore` tracks shared rules and skills; removed legacy `.cursor/agents/` briefs.
