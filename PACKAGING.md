...
Example template path in this repo: `packaging/winget/manifests/c/Cod-e-Codes/Marchat/1.3.6/` (duplicate the folder layout for new versions). Older **`1.0.0/`**, **`1.1.0/`**, **`1.2.0/`**, **`1.3.0/`**, **`1.3.1/`**, **`1.3.2/`**, **`1.3.3/`**, **`1.3.4/`**, and **`1.3.5/`** manifests may remain for reference; the current release templates target **v1.3.6** until the next bump.
