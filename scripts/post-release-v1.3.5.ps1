# Post-release packaging for v1.3.5 (run after GitHub release assets are uploaded).
# Does NOT commit or push - prints commands at the end.
#
# Usage:
#   cd marchat
#   .\scripts\post-release-v1.3.5.ps1
...
Write-Host @"
cd "$RepoRoot"
git add packaging/ release-notes-v1.3.5.md
git commit -m "chore(packaging): sync v1.3.5 release checksums"
