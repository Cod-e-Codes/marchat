# Post-release packaging for v1.3.6 (run after GitHub release assets are uploaded).
# Does NOT commit or push - prints commands at the end.
#
# Usage:
#   cd marchat
#   .\scripts\post-release-v1.3.6.ps1
...
cd "$RepoRoot"
git add packaging/
git commit -m "chore(packaging): sync v1.3.6 release checksums"
